$(document).ready(function(){
    'use strict';$('.menu > ul > li:has( > ul)').addClass('menu-dropdown-icon');
    $('.menu > ul > li > ul:not(:has(ul))').addClass('normal-sub');
    if(window.location.href.indexOf('product')>-1)
    {$('.menu > ul').before('<a href="../index.html" class="menu-mobile"><img src="../images/Tate-Logo-Web3.png" alt="Tate logo" /></a>');}
    else{$('.menu > ul').before('<a href="index.html" class="menu-mobile"><img src="images/Tate-Logo-Web3.png" alt="Tate logo" /></a>');}
